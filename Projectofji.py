...
word_list = ["car", "dog", "cat", "shoes", "bloom", "book", "belt", "microwave", "shirts", "gloves", "clock", \
"laptop", "chair", "pencil", "knife", "printer", "silent", "majority", "elevator"]
...
"Cover your hands", "It's a device for showing time", "It's like a computer but smaller", \
"Used for sit", "Used for writing or drawing", "It's used for cutting", \
"Used when you need to print something", "When thing goes quiet", "Most", \
"Used for lifting people"]
photos = [tk.PhotoImage(file=r"C:\Users\admin\Desktop\projo\hang4.png")\
    , tk.PhotoImage(file=r'C:\Users\admin\Desktop\projo\hang5.png')\
    , tk.PhotoImage(file=r'C:\Users\admin\Desktop\projo\hang6.png')\
    , tk.PhotoImage(file=r'C:\Users\admin\Desktop\projo\hang7.png')\
    , tk.PhotoImage(file=r'C:\Users\admin\Desktop\projo\hang8.png')\
    , tk.PhotoImage(file=r'C:\Users\admin\Desktop\projo\hang9.png')\
    , tk.PhotoImage(file=r'C:\Users\admin\Desktop\projo\hang10.png')\
    , tk.PhotoImage(file=r'C:\Users\admin\Desktop\projo\hang11.png')]
